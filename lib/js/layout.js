...
var Layout = function () {
            ...
            if ($('body').hasClass("page-sidebar-closed")) {
                if ($('.sidebar-search').hasClass('open') === false) {
                    if ($('.page-sidebar-fixed').size() === 1) {
                        $('.page-sidebar .sidebar-toggler, .sidebar-toggler-logo').click(); //trigger sidebar toggle button
                    }
    ...
    return {
        ...
        initContent: function() {
            ...
            //checar esto italo //Metronic.addResizeHandler(handleSidebarAndContentHeight); // recalculate sidebar & content height on window resize
        ...
        // (agregado a functions.js)
        /*init: function () {            
            this.initHeader();
            this.initSidebar();
            this.initContent();
            //this.initFooter(); (agregado a functions.js)
        },*/
